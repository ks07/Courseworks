...
\begin{lstlisting}
# Receive as input a text string T of length n, a pattern string P of length m, and a non-negative integer k denoting the maximum cost of errors.
...
for i in range(0, n):
  ...
  if L < m:
    ...
    while TC <= k:
      ...
      j = j + L
      if j > m or i > n:
        # We have reached the end of either text or pattern, must stop.
        break
      else:
        TC = TC + (m/L)
