...
i.e. \(u = m^2 = 4\). This corner case can be explained by considering that it would cause there to be only two possible blocks (or choices of \(k\)), and thus for distinct keys it must be a \(\frac{1}{2}\) probability of collision, which is equal to \(\frac{1}{m = 2}\).
