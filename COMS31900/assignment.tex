...
# Search down the tree for the successor of Y1. (O(log n))
Current = Split.left
while Current is not None:
  if Y1 <= Current.y:
    # Count this node if the X coordinate is within range.
    if X1 <= Current.x <= X2:
      k = k + 1
    ...
    # This node is outside the range, recurse to the right subtree.
    Current = Current.right

# Search down the tree for the predecessor of Y2. (O(log n))
Current = Split.right
while Current is not None:
  if Current.y <= Y2:
    # Count this node if the X coordinate is within range.
    ...
    # This node is outside the range, recurse to the left subtree.
    Current = Current.left
