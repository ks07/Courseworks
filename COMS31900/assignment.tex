...
if d == 2:
  ...
  while Current is not None:
    if ld <= Current.dim[d]:
      ...
      k_right = RangeCountDD(Root=Current.right, d=d-1, B=[l1, h1 ... l(d-1), h(d-1)])
      k = k + k_right
  ...
  while Current is not None:
    if Current.dim[d] <= hd:
      ...
      k_left = RangeCountDD(Root=Current.left, d=d-1, B+[l1, h1 ... l(d-1), h(d-1)])
      k = k + k_left
